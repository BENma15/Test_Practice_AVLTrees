...
class AVLTree {
 private:
  ...
  // TODO: Helper functions for AVL operations
  // - int GetHeight(Node* n) -> int - Get height of a node
  // - int GetBalance(Node* n) -> int - Get balance factor of a node
  // - void UpdateHeight(Node* n) -> void - Update height of a node
  // - Node* RotateLeft(Node* n) -> Node* - Left rotation
  // - Node* RotateRight(Node* n) -> Node* - Right rotation
  // - Node* RotateLeftRight(Node* n) -> Node* - Left-Right rotation
  // - Node* RotateRightLeft(Node* n) -> Node* - Right-Left rotation
  // - Node* Rebalance(Node* n) -> Node* - Rebalance after insertion/deletion
